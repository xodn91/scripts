...
MIN_LENGTH=16                    # at least 16 chars for password
MIN_NUMERIC=0                   # at least 0 number in password
MIN_ALPHA_LOWER=0               # at least 0 lower case letter in password
MIN_UPPER_ALPHA=0               # at least 0 upper case letter in password
